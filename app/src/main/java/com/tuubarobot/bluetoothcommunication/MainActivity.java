...
//    private Button changeRecycleVisible;
    private Button addCustomDialog;
...
//        });
        ...
        addCustomDialog.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.d(TAG, "addCustomDialog onClick: ");
...
//        deviceRecyclerView= (RecyclerView) findViewById(R.id.deviceRecyclerView);
        addCustomDialog= (Button) findViewById(R.id.addCustomDialog);
