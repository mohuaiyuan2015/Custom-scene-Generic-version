...
public class ActionInfo {
    ...
    public static final String ACTION_INFO_ID="id";
    public static final String ACTION_INFO_NAME="name";
    public static final String ACTION_INFO_OPERATION_TIME="operationTime";
    public static final String ACTION_INFO_TO_BE_OPERATION_TIME="toBeOperationTime";
